...
**Il doit faire partie de l'histoire de votre journée.**`,
  ...
  dishes: [
    ...
    { id: 'menu-22', name: 'Tartelette fraise', image: '/shooting la saveur etoilee/nos plats 22.jpg', description: 'Crème diplomate saveur fève de tonka et vanille de Madagascar' },
    { id: 'menu-23', name: 'Tartelette fraise', image: '/shooting la saveur etoilee/nos plats 23.jpg', description: 'Crème diplomate saveur fève de tonka et vanille de Madagascar' },
