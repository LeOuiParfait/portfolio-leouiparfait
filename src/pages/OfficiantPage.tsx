...
const MEDIA_MENTIONS = [
  { name: 'France 3', type: 'Télévision', icon: Tv },
  { name: 'BFM TV', type: 'Télévision', icon: Tv },
  { name: 'C8', type: 'Télévision', icon: Tv },
  { name: 'À la radio', type: 'Radio', icon: Radio },
  { name: 'Dans la presse', type: 'Presse écrite', icon: Newspaper },
];
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            {/* Liens rapides — Instagram, Mariages.net */}
            <Reveal variant="up" delay={240}>
              <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-4">
                ...
                <a
                  href="https://www.mariages.net/organisation-mariage/noce-de-reve-by-flovinno--e15830"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-full border text-xs sm:text-sm font-sans-clean transition-all ${
                    isDarkMode
      ...
      >
        <div className="max-w-5xl mx-auto">
          <Reveal variant="fade" className="mb-10 sm:mb-14 text-center">
            ...
            >
              Cérémonie de Rêve by FLOVINNO a été mentionné dans plusieurs médias
              télévisés, radiophoniques et presse écrite.
            </p>
          </Reveal>

          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {MEDIA_MENTIONS.map((media, i) => (
              <Reveal key={i} variant="up" delay={i * 60}>
                <div
                  className={`flex flex-col items-center gap-3 rounded-2xl border p-6 text-center h-full ${
                    isDarkMode
                      ? 'bg-[#1c1a17] border-[#332f28]'
                      : 'bg-[#faf8f5] border-[#e8e4dc]'
                  }`}
                >
                  ...
                  <div>
                    <p
                      className={`font-serif-main text-base sm:text-lg ${
                        isDarkMode ? 'text-[#c8c0f5]' : 'text-[#2c2b29]'
                      }`}
                    >
                      {media.name}
                    ...
                    <p
                      className={`text-[10px] uppercase tracking-widest font-sans-clean mt-1 ${
                        isDarkMode ? 'text-[#807b71]' : 'text-[#8a8780]'
                      }`}
                    >
                      {media.type}
          ...
          <Reveal variant="up" delay={200}>
            <div className="mt-10 text-center">
              <a
                href="https://www.nocedereve.fr/on-parle-de-nous"
                target="_blank"
                rel="noopener noreferrer"
                className={`inline-flex items-center gap-2 px-6 py-3 rounded-full font-sans-clean font-medium text-sm transition-all shadow-lg active:scale-95 ${
                  isDarkMode
              ...
              >
                ...
                Découvrir toutes nos apparitions
              </a>
            </div>
          </Reveal>
        </div>
