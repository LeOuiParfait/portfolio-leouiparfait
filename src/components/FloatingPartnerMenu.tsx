...
export const FloatingPartnerMenu: React.FC<FloatingPartnerMenuProps> = ({
  ...
  const menuItems = [
    ...
    {
      to: '/animation',
      label: 'Animation Enfants',
      icon: Sparkles,
      description: 'Oui Oui Kids × Maison des 4A',
    },
    {
      to: '/flamenco',
      label: 'Flamenco Live',
      icon: Music,
      description: 'Performance scénique & guitare live',
    },
    {
      to: '/officiant',
      label: 'Officiant',
      icon: Heart,
      description: 'Cérémonie de Rêve by FLOVINNO',
    },
    {
      to: '/nora',
      label: 'Les Délices de Nora',
      icon: Cake,
      description: 'Wedding cakes & pâtisseries sur-mesure',
    },
  ];
